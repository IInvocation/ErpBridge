...
public abstract class DummyModelAdapter<TModel> : IModelAdapter<TModel>
{
    ...
    public abstract TModel? GetByPrimaryKey(string primaryKey);

    /// <summary>   Gets by primary key asynchronous. </summary>
    /// <param name="primaryKey">           The primary key. </param>
    /// <param name="cancellationToken">    A token that allows processing to be cancelled. </param>
    /// <returns>   The by primary key. </returns>
    public Task<TModel?> GetByPrimaryKeyAsync(string primaryKey, CancellationToken cancellationToken)
    {
        return Task.FromResult(GetByPrimaryKey(primaryKey));
    }
